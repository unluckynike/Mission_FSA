    ...
    <nav class="navbar navbar-default">
        <div class="topbar">
            ...
            <div class="topbar-left">
                ...
                <span class="navbar-page-title"> 基于遗传算法的软件项目智慧及管理调度系统 </span>
            </div>
            ...
            <ul class="topbar-right">
                <li class="dropdown dropdown-profile">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        ...
                        <li> <a href="${pageContext.request.contextPath }/fas/clean"><i class="mdi mdi-delete"></i> 清空缓存</a></li>
                        <li class="divider"></li>
                        <li> <a href="../system/index"><i class="mdi mdi-logout-variant"></i> 退出登录</a> </li>
                    </ul>
                </li>
                <!--切换主题配色-->
