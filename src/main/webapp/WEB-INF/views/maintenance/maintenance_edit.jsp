...
<div class="lyear-layout-container">
    ...
    <main class="lyear-layout-content">
        ...
        <div class="container-fluid">
            <div class="col-md-6">
                <c:forEach items="${maintenanceInfor}" var="maintenance" varStatus="vs">
                <div class="card">
                    <div class="card-header"><h4>修改项目【 ${maintenance.projectname } 】</h4></div>
                    <c class="card-body">

                        <form class="form-horizontal" action="${pageContext.request.contextPath }/fas/doeditedesign?id=${maintenance.id}" method="post">
