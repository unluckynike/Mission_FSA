...
<%--                                <a class="btn btn-primary m-r-5" href="#!"><i class="mdi "></i></a>--%>
                                <a class="btn btn-success m-r-5" href="#!"><i class="mdi mdi-human-handsdown"></i>设计列表</a>
                        ...
                        <div class="card-body">
                            ...
                            <c:forEach items="${designs}" var="design" varStatus="vs">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a class="btn btn-xs btn-default" href="${pageContext.request.contextPath }/fas/editdesign?id=${design.id }" title="编辑" data-toggle="tooltip"><i class="mdi mdi-pencil"></i></a>
<%--                                                <a class="btn btn-xs btn-default" href="#!" title="查看" data-toggle="tooltip"><i class="mdi mdi-eye"></i></a>--%>
                                                <a class="btn btn-xs btn-default" href="${pageContext.request.contextPath }/fas/deletedesign?id=${design.id }" title="删除" data-toggle="tooltip"><i class="mdi mdi-window-close"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                    </tbody>
